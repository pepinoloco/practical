module practical/appendix-b/http-server
...
require (
	...
	practical/appendix-b/grpc-server/service v0.0.0
...
replace practical/appendix-b/grpc-server/service => ../grpc-server/service

replace practical/appendix-a/grpc-server/service => ../grpc-server/service
